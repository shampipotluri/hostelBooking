...
try{
        ...
        PreparedStatement pst=co.prepareStatement("select * from hostel where type='"+type+"' and food='"+food+"' and price='"+price+"' and location='"+location+"' and cn='"+cn+"'  ");
        ResultSet rs=pst.executeQuery();
      
    %>
 <br><br><br><br><br>
<center><h2 style="color:black;font-size: 20px;"><b>View Hostel</b></h2></center>
<center>
  ...
  <thead style="background-color: pink;color:whitesmoke">
    <tr>
        ...
        <th style="text-align:center" scope="col" >Food</th>
         <th style="text-align:center" scope="col" >Price</th>
          <th style="text-align:center" scope="col" >Location</th>
           <th style="text-align:center" scope="col" >College</th>
  ...
  <tbody style="text-align: center;">
    ...
    <tr  style="background: rgba(0,0,0,0.5); color: wheat" >
     ...
     <td><button class="btn btn-primary"><a href="book.jsp?username=<%=rs.getString(1)%>&hname=<%=rs.getString(2)%>&type=<%=rs.getString(3)%>&food=<%=rs.getString(4)%>&price=<%=rs.getString(5)%>&location=<%=rs.getString(6)%>"><b>Book</b></a></button> </td>
    </tr>
    <%}%>
  </tbody>
</table>
