...
try{
        ...
        PreparedStatement pst=co.prepareStatement("select * from book where guest='"+username+"'");
...
<center>
        ...
        <th style="text-align:center" scope="col" >Food</th>
         <th style="text-align:center" scope="col" >Price</th>
          <th style="text-align:center" scope="col" >Location</th>
           ...
           <th style="text-align:center" scope="col" >Feed Back</th>
    </tr>
  </thead>
  <tbody style="text-align: center;">
    ...
    <td><button class="btn btn-primary"><a href="fb.jsp?username=<%=rs.getString(1)%>&hname=<%=rs.getString(2)%>"><b>Feed Back</b></a></button> </td>
    </tr>
    <%}%>
  </tbody>
</table>
