...
try{
        ...
        PreparedStatement pst=co.prepareStatement("select * from guest ");
        ResultSet rs=pst.executeQuery();
      
    %>
 <br><br><br><br><br>
<center><h2 style="color:black;font-size: 20px;"><b>View Guest</b></h2></center>
<center>
  ...
  <tbody style="text-align: center;">
    ...
    <tr  style="background: rgba(0,0,0,0.5); color: wheat" >
     ...
     <td><button class="btn btn-primary"><a href="vgd.jsp?username=<%=rs.getString(1)%>&email=<%=rs.getString(2)%>"><b>Delete</b></a></button> </td>
    </tr>
    <%}%>
  </tbody>
</table>
