      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          <li><a href="hosthome.jsp">Home</a></li>
           <li class="active"><a href="addhostel.jsp">Add Hostel</a></li>
  ...
  %>
	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
                            <form action="ahact.jsp" method="post">
					...
					<div class="input-group form-group">
						<div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control" placeholder="Hostel Name" name="hname" required="">
					</div>
                                    <div class="input-group form-group">
						<div class="input-group-prepend">
						</div>
						...
						<div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" placeholder="College Name" name="cn" required="">
					</div>
