    ...
    <div class="container">
     ...
     <ul>
          <li><a href="hosthome.jsp">Home</a></li>
           ...
           <li><a href="uphostel.jsp">Update Hostel</a></li>
            <li class="active"><a href="vr.jsp">View Request</a></li>
...
try{
        ...
        PreparedStatement pst=co.prepareStatement("select * from book where host='"+username+"'");
...
<center>
  ...
  <thead style="background-color: pink;color:whitesmoke">
    <tr>
      ...
      <th style="text-align:center" scope="col">Respond</th>
    </tr>
  </thead>
  <tbody style="text-align: center;">
    ...
    <tr  style="background: rgba(0,0,0,0.5); color: wheat" >
     ...
     <td><button class="btn btn-primary"><a href="vr1.jsp?host=<%=rs.getString(1)%>&hname=<%=rs.getString(2)%>&guest=<%=rs.getString(7)%>"><b>Accept</b></a></button> </td>
    </tr>
    <%}%>
  </tbody>
</table>
