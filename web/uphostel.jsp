...
try{
        ...
        PreparedStatement pst=co.prepareStatement("select * from hostel where username='"+username+"'");
...
<center>
  ...
  <tbody style="text-align: center;">
    ...
    <tr  style="background: rgba(0,0,0,0.5); color: wheat" >
     ...
     <td><button class="btn btn-primary"><a href="update1.jsp?username=<%=rs.getString(1)%>&hname=<%=rs.getString(2)%>&type=<%=rs.getString(3)%>&food=<%=rs.getString(4)%>&price=<%=rs.getString(5)%>&location=<%=rs.getString(6)%>"><b>Update</b></a></button> </td>
    </tr>
    <%}%>
  </tbody>
</table>
